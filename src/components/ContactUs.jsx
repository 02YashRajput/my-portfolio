...
const ContactUs = ({ contactRef }) => {
  ...
  const submitHandler = (e) => {
    ...
    const templateParams = {
      to_name: "Yash Rajput", // Your name or the recipient's name
  ...
  return (
    <div ref={contactRef} className="flex flex-col items-center justify-center gap-20 px-10 py-36 bg-muted">
      ...
      <div className="text-4xl flex gap-8">
        <button
          onClick={() => {
            window.open("https://www.instagram.com/iam_y.r", "_blank");
          }}
        >
          <FaSquareInstagram />
        </button>
        <button
          onClick={() => {
            window.open(
              "https://www.facebook.com/profile.php?id=100083846002768",
              "_blank"
            );
          }}
        >
        ...
        <button
          onClick={() => {
            window.open("https://x.com/02YashRajput", "_blank");
          }}
        >
          <FaSquareXTwitter />
        </button>
        <button
          onClick={() => {
            window.open("https://github.com/02YashRajput", "_blank");
          }}
        >
          <FaGithubSquare/>
        </button>
